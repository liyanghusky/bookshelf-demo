 ...
 "categories": [
  {
   "id": "fiction",
   "name": "Fiction",
   "tagline": "Novels & tales"
  },
  {
   "id": "mystery",
   "name": "Mystery",
   "tagline": "Crime & detection"
  },
  {
   "id": "scifi",
   "name": "Science Fiction",
   "tagline": "Worlds to come"
  },
  {
   "id": "philosophy",
   "name": "Philosophy",
   "tagline": "Ideas & ethics"
  },
  {
   "id": "poetry",
   "name": "Poetry",
 ...
 "books": [
  {
   ...
   "author": "Jane Austen",
   "category": "fiction",
   "blurb": "A sharp, witty comedy of manners on love, class and first impressions in Regency England.",
   "words": 1469,
   "chapters": [
    {
     "title": "Chapter I",
  ...
  },
  {
   ...
   "category": "fiction",
   "blurb": "Ishmael ships aboard the Pequod under Captain Ahab's monomaniacal hunt for a white whale.",
   "words": 4634,
   "chapters": [
    {
    ...
    },
    {
     ...
     "paragraphs": [
      ...
      "But what most puzzled and confounded you was a long, limber, portentous, black mass of something hovering in the centre of the picture over three blue, dim, perpendicular lines floating in a nameless yeast. A boggy, soggy, squitchy picture truly, enough to drive a nervous man distracted. Yet was there a sort of indefinite, half-attained, unimaginable sublimity about it that fairly froze you to it, till you involuntarily took an oath with yourself to find out what that marvellous painting meant. Ever and anon a bright, but, alas, deceptive idea would dart you through.—It’s the Black Sea in a midnight gale.—It’s the unnatural combat of the four primal elements.—It’s a blasted heath.—It’s a Hyperborean winter scene.—It’s the breaking-up of the icebound stream of Time. But at last all these fancies yielded to that one portentous something in the picture’s midst. _That_ once found out, and all the rest were plain. But stop; does it not bear a faint resemblance to a gigantic fish? even the great leviathan himself?",
  ...
  },
  {
   ...
   "category": "fiction",
   "blurb": "A curious girl tumbles down a rabbit hole into a world of riddling logic and talking creatures.",
   "words": 1863,
   "chapters": [
    {
     "title": "CHAPTER I",
  ...
  },
  {
   ...
   "category": "mystery",
   "blurb": "Twelve cases of the world's first consulting detective and his cool deductive genius.",
   "words": 2046,
   "chapters": [
    {
     "title": "I",
  ...
  },
  {
   ...
   "category": "mystery",
   "blurb": "A cursed Indian diamond vanishes in an English country house — the first great detective novel.",
   "words": 2261,
   "chapters": [
    {
     "title": "CHAPTER X",
    ...
    },
    {
     ...
     "type": "prose",
     "paragraphs": [
      "In the first part of _Robinson Crusoe_, at page one hundred and twenty-nine, you will find it thus written:",
      "“Now I saw, though too late, the Folly of beginning a Work before we count the Cost, and before we judge rightly of our own Strength to go through with it.”",
      "Only yesterday, I opened my _Robinson Crusoe_ at that place. Only this morning (May twenty-first, eighteen hundred and fifty), came my lady’s nephew, Mr. Franklin Blake, and held a short conversation with me, as follows:—",
    ...
    },
    {
     ...
     "paragraphs": [
      ...
      "Well, there I was in clover, you will say. Placed in a position of trust and honour, with a little cottage of my own to live in, with my rounds on the estate to occupy me in the morning, and my accounts in the afternoon, and my pipe and my _Robinson Crusoe_ in the evening—what more could I possibly want to make me happy? Remember what Adam wanted when he was alone in the Garden of Eden; and if you don’t blame it in Adam, don’t blame it in me.",
  ...
  },
  {
   ...
   "author": "Arthur Conan Doyle",
   "category": "mystery",
   "blurb": "A spectral hound stalks the moors of Devon, and Holmes hunts the truth behind the legend.",
   "words": 1096,
   "chapters": [
    {
     "title": "Chapter 1",
  ...
  },
  {
   ...
   "author": "H. G. Wells",
   "category": "scifi",
   "blurb": "An inventor travels to the year 802,701 and finds humanity split into two strange species.",
   "words": 3562,
   "chapters": [
    {
     "title": "I",
  ...
  },
  {
   ...
   "author": "Mary Shelley",
   "category": "scifi",
   "blurb": "Victor Frankenstein animates a creature from dead matter — and is hunted by his own creation.",
   "words": 3746,
   "chapters": [
    {
     "title": "Letter 1",
  ...
  },
  {
   ...
   "author": "H. G. Wells",
   "category": "scifi",
   "blurb": "Martian war machines land in England and the thin veneer of civilization collapses.",
   "words": 2495,
   "chapters": [
    {
     "title": "I",
  ...
  },
  {
   ...
   "category": "philosophy",
   "blurb": "The private notebook of a Roman emperor on duty, mortality and the discipline of the mind.",
   "words": 4526,
   "chapters": [
    {
    ...
    {
     "title": "III. They seek for themselves private retiring",
     "type": "prose",
     "paragraphs": [
  ...
  },
  {
   ...
   "author": "Lao Tzu",
   "category": "philosophy",
   "blurb": "Eighty-one verses on the Way — yielding, simplicity, and the power of non-action.",
   "words": 1065,
   "chapters": [
    {
     "title": "Section 1",
  ...
  },
  {
   ...
   "category": "philosophy",
   "blurb": "A daring attack on traditional morality and a call for a philosophy of the future.",
   "words": 6366,
   "chapters": [
    {
     "title": "CHAPTER IX: WHAT IS NOBLE?",
     "type": "prose",
     "paragraphs": [
    ...
    {
     "title": "CHAPTER II. THE FREE SPIRIT",
     "type": "prose",
     "paragraphs": [
    ...
    {
     "title": "CHAPTER III. THE RELIGIOUS MOOD",
     "type": "prose",
     "paragraphs": [
    ...
    {
     "title": "CHAPTER IV. APOPHTHEGMS AND INTERLUDES",
     "type": "prose",
     "paragraphs": [
  ...
  },
  {
   ...
   "author": "Walt Whitman",
   "category": "poetry",
   "blurb": "Sprawling, ecstatic free verse celebrating the body, democracy and the American self.",
   "words": 557,
   "chapters": [
    {
     "title": "Poem 1",
  ...
  },
  {
   ...
   "category": "poetry",
   "blurb": "Terse, electric lyrics on death, immortality and the inner life, dashed and slant-rhymed.",
   "words": 217,
   "chapters": [
    {
     "title": "Poem 1",
  ...
  },
  {
   ...
   "category": "poetry",
   "blurb": "154 sonnets on love, time, beauty and mortality — the summit of the English lyric.",
   "words": 858,
   "chapters": [
    {
     "title": "Poem 1",
  ...
  },
  {
   ...
   "category": "fiction",
   "blurb": "The orphan Pip is raised to be a gentleman by a mysterious benefactor — and learns its cost.",
   "words": 2215,
   "chapters": [
    {
     "title": "Chapter I",
  ...
  },
  {
   ...
   "author": "Arthur Conan Doyle",
   "category": "mystery",
   "blurb": "A pact of stolen Agra treasure, a one-legged man, and Holmes at his most restless and brilliant.",
   "words": 1595,
   "chapters": [
    {
     "title": "Chapter I",
  ...
  },
  {
   ...
   "author": "H. G. Wells",
   "category": "scifi",
   "blurb": "A scientist discovers invisibility — and the power unhinges him into terror and tyranny.",
   "words": 2663,
   "chapters": [
    {
     "title": "CHAPTER I",
  ...
  },
  {
   ...
   "author": "Jules Verne",
   "category": "scifi",
   "blurb": "Captain Nemo and the Nautilus carry three captives on a wondrous, vengeful voyage beneath the waves.",
   "words": 2168,
   "chapters": [
    {
     "title": "CHAPTER I",
     ...
     "paragraphs": [
      ...
      "Similar facts were observed on the 23rd of July in the same year, in the Pacific Ocean, by the _Columbus_, of the West India and Pacific Steam Navigation Company. But this extraordinary cetaceous creature could transport itself from one place to another with surprising velocity; as, in an interval of three days, the _Governor Higginson_ and the _Columbus_ had observed it at two different points of the chart, separated by a distance of more than seven hundred nautical leagues.",
      "Fifteen days later, two thousand miles farther off, the _Helvetia_, of the Compagnie-Nationale, and the _Shannon_, of the Royal Mail Steamship Company, sailing to windward in that portion of the Atlantic lying between the United States and Europe, respectively signalled the monster to each other in 42° 15′ N. lat. and 60° 35′ W. long. In these simultaneous observations they thought themselves justified in estimating the minimum length of the mammal at more than three hundred and fifty feet, as the _Shannon_ and _Helvetia_ were of smaller dimensions than it, though they measured three hundred feet over all."
     ]
    },
    {
     "title": "CHAPTER II",
    ...
    },
    {
     ...
     "type": "prose",
     "paragraphs": [
      "The voyage of the _Abraham Lincoln_ was for a long time marked by no special incident. But one circumstance happened which showed the wonderful dexterity of Ned Land, and proved what confidence we might place in him.",
      "The 30th of June, the frigate spoke some American whalers, from whom we learned that they knew nothing about the narwhal. But one of them, the captain of the _Monroe_, knowing that Ned Land had shipped on board the _Abraham Lincoln_, begged for his help in chasing a whale they had in sight. Commander Farragut, desirous of seeing Ned Land at work, gave him permission to go on board the _Monroe_. And fate served our Canadian so well that, instead of one whale, he harpooned two with a double blow, striking one straight to the heart, and catching the other after some minutes’ pursuit.",
      ...
      "The 6th of July, about three o’clock in the afternoon, the _Abraham Lincoln_, at fifteen miles to the south, doubled the solitary island, this lost rock at the extremity of the American continent, to which some Dutch sailors gave the name of their native town, Cape Horn. The course was taken towards the north-west, and the next day the screw of the frigate was at last beating the waters of the Pacific."
     ]
    }
   ]
  },
  {
   ...
   "author": "塞万提斯",
   "category": "fiction",
   "blurb": "疯魔于骑士小说的拉曼却绅士,跨上瘦马仗剑出行,要去复兴早已消亡的游侠骑士道——西方第一部现代小说。",
   "words": 789,
   "chapters": [
    {
     "title": "第一章 · 拉曼却的绅士",
     "type": "prose",
     "paragraphs": [
      "在拉曼却的一个村庄里——村名我并不想费心提起——不久之前住着一位绅士。他属于那一类绅士:枪架上照例插着一支长矛,还有一面古旧的皮盾、一匹瘦马,和一条用来追猎的灵缇。",
      "要知道,这位绅士一有空闲(他几乎一年到头都是空闲的),便埋头去读骑士小说,读得那样入迷、那样贪婪,以至几乎把打猎的事、连同自家产业的料理都抛在了脑后。他痴迷到了这般地步,竟变卖了好几亩良田去买骑士小说来读,凡能弄到手的都搬回了家。",
      "他常常和村里的神父(此人很有学问,是西贡萨毕业的)争论不休:究竟谁才是更出色的骑士——英格兰的帕尔梅林,还是高卢的阿马迪斯。"
     ]
    },
    {
     "title": "第二章 · 初次出征",
     "type": "prose",
     "paragraphs": [
      "这些准备一经定妥,他便不愿再拖延自己的计划。一想到他的迟疑正让世人蒙受多大的损失,他就再也按捺不住——他要去伸雪多少冤屈、纠正多少不平、扫除多少弊端、偿清多少亏欠啊。",
      "就这样,我们这位初出茅庐的冒险家一路前行,一边自言自语:“谁知道呢,将来有一天,当我那些丰功伟绩的信史公诸于世,那位执笔的贤者写到我清晨头一次出征时,会不会就这样下笔——”",
      "他就这样把这一类荒唐话连缀下去,全是从书里学来的腔调,竭力模仿那些文辞;而他骑得那样慢,太阳却升得那样快、那样毒,真足以把他的脑子晒化——倘若他还有脑子的话。"
     ]
    },
    {
     "title": "第三章 · 受封骑士",
     "type": "prose",
     "paragraphs": [
      "这念头搅得他不安,便草草吃完客店里那顿简陋的晚饭,随即唤来店主,把自己同他一起关进马厩,跪倒在他面前说:“英勇的骑士啊,您若不答应我所求的恩典,我便长跪于此、绝不起身。我所求的事,将为您增光,也将造福于全人类。”",
      "那店主,前面已经说过,本是个爱打趣的人,早已疑心这位客人脑筋不大正常;一听他这番言语,更是深信不疑。为了寻个通宵的乐子,他便决意顺着他的疯劲儿来。",
      "堂吉诃德答应一丝不苟地照办。当下议定:他要在客店一侧的大院里看守自己的甲胄。于是他把甲胄统统收拢,放在井边的一只石槽上,把皮盾往臂上一挎,握起长矛,神态庄严地在石槽前来回踏步;他刚开始踏步,夜色也就降临了。"
     ]
    }
   ],
   "edition": "中译本 · 外国文学"
  },
  {
   ...
   "author": "陀思妥耶夫斯基",
   "category": "fiction",
   "blurb": "穷困潦倒的大学生杀死放高利贷的老太婆,真正追捕他的不是警察,而是他自己的良心。",
   "words": 581,
   "chapters": [
    {
     "title": "第一章",
     "type": "prose",
     "paragraphs": [
      "七月初一个酷热异常的傍晚,一个青年走出他在S巷租住的那间斗室,慢吞吞地、像是犹疑不决地朝K桥走去。",
      "他顺利地避开了在楼梯上撞见房东太太。他那间斗室在一幢五层高楼的屋顶底下,与其说是房间,不如说更像一只柜橱。",
      "这并非因为他怯懦卑屈,恰恰相反;只是近来他一直处在一种过度紧张、易怒的状态,近乎臆想症。他完全沉溺于自我,与周围的人隔绝开来,以至于不仅怕见房东太太,简直怕见任何人。"
     ]
    },
    {
     "title": "第二章",
     "type": "prose",
     "paragraphs": [
      "拉斯柯尔尼科夫不惯于人群,如前所说,他向来回避一切交际,近来尤甚。可此刻,他忽然渴望同别人待在一起。仿佛有种新的东西正在他心里萌动,随之而来的,是一种对人群的渴求。",
      "店主在另一个房间里,却时常踏下几级台阶,走进这间正屋来;每次,总是他那双神气的、上了油的长靴先露面——靴筒翻口是红的——然后才轮到他这个人。",
      "有些与陌生人的萍水相逢,从头一眼起、还未交谈一语,就叫我们觉得有趣。坐在离他不远处那个人,给拉斯柯尔尼科夫的,正是这样一种印象——那人看上去像个退职的小公务员。"
     ]
    },
    {
     "title": "第三章",
     "type": "prose",
     "paragraphs": [
      "第二天他醒得很晚,睡得断断续续。睡眠并没有使他复元;他醒来时满腹郁结、烦躁易怒,恶狠狠地打量着自己的房间。那是一间柜橱似的小屋,长不过六步。",
      "这屋子破败凌乱,简直再难往下沉沦了;然而对眼下这种心境的拉斯柯尔尼科夫来说,这反倒叫他称心。",
      "“起来吧,怎么还睡?”她朝他喊道,“九点都过了,我给你端了茶来;喝一杯吗?我看你怕是饿坏了吧?”"
     ]
    }
   ],
   "edition": "中译本 · 外国文学"
  },
  {
   ...
   "author": "陀思妥耶夫斯基",
   "category": "fiction",
   "blurb": "三兄弟与放荡的父亲之间,信仰、怀疑与弑父之罪激烈碰撞——陀思妥耶夫斯基的思想巅峰。",
   "words": 587,
   "chapters": [
    {
     "title": "第一章 · 老卡拉马佐夫",
     "type": "prose",
     "paragraphs": [
      "阿历克塞·费奥多罗维奇·卡拉马佐夫,是我们县里一位地主费奥多尔·巴甫洛维奇·卡拉马佐夫的第三个儿子。这位地主当年颇有名气,至今仍为人们记得,只因他那阴郁而惨烈的死——那是十三年前的事了,我将在适当的地方加以叙述。",
      "他结过两次婚,有三个儿子:长子德米特里是前妻所生,伊万和阿历克塞两个则是后妻所出。费奥多尔·巴甫洛维奇的前妻阿杰拉伊达·伊万诺夫娜,出身于本县一个相当富有、显赫的贵族世家米乌索夫家,也是地主。",
      "私奔之后没多久,阿杰拉伊达·伊万诺夫娜便一下子看清:对丈夫她除了鄙夷,再无别的情感。于是这桩婚姻极快地露出了它的本来面目。"
     ]
    },
    {
     "title": "第二章 · 撒手不管的父亲",
     "type": "prose",
     "paragraphs": [
      "这样一个人会是怎样的父亲、会怎样教养自己的孩子,不难想见。他作为父亲的所作所为,恰如人们所能料到的那样。",
      "而且事情还凑巧,起初连孩子母亲那边的亲戚也把他给忘了。",
      "费奥多尔·巴甫洛维奇一生都爱做戏,爱出其不意地扮演某个角色,有时全无缘由,甚至明明对自己不利也照演不误——眼下这件事便是一例。"
     ]
    },
    {
     "title": "第三章 · 第二次婚姻与第二个家",
     "type": "prose",
     "paragraphs": [
      "把四岁的米嘉打发走后没多久,费奥多尔·巴甫洛维奇便第二次结了婚。这第二次婚姻维持了八年。他的第二个妻子索菲娅·伊万诺夫娜也是个很年轻的姑娘,是他到外省办一桩小买卖、与一个犹太人同行时娶来的。",
      "费奥多尔·巴甫洛维奇向她求婚;人家打听了他的底细,便回绝了。可是,正如头一回婚姻那样,他又向这个孤女提议私奔。几乎可以断定:倘若她当初对他多了解一些,无论如何也不会嫁给他的。"
     ]
    }
   ],
   "edition": "中译本 · 外国文学"
  },
  {
   ...
   "author": "列夫·托尔斯泰",
   "category": "fiction",
   "blurb": "拿破仑入侵的烽火中,几大贵族家庭的爱恨与一个民族的灵魂,在恢弘画卷上徐徐铺展。",
   "words": 551,
   "chapters": [
    {
     "title": "第一章 · 舍勒的晚会",
     "type": "prose",
     "paragraphs": [
      "“啊,公爵,热那亚和卢卡如今都成了波拿巴家的私产啦。”",
      "那是一八〇五年七月,说话的是赫赫有名的安娜·帕夫洛夫娜·舍勒——皇后玛丽亚·费奥多罗夫娜跟前的女官兼宠儿。她这样招呼头一个到场的贵客瓦西里·库拉金公爵,一位身居高位、举足轻重的人物。安娜·帕夫洛夫娜已经咳嗽了好几天。",
      "她那些请柬无一例外都用法文写成,当天早晨由一名身穿猩红号衣的仆人送出,措辞如下:"
     ]
    },
    {
     "title": "第二章 · 高朋满座",
     "type": "prose",
     "paragraphs": [
      "安娜·帕夫洛夫娜的客厅渐渐坐满了人。彼得堡最上流的社会都汇集于此:这些人年纪、性情各不相同,却同属一个社交圈子。",
      "每来一位客人,安娜·帕夫洛夫娜总要说一句:“您还没见过我姑妈吧,”或者“您不认识我姑妈吧?”",
      "她把每位来客依次引到坐在一旁的姑妈跟前,低声通报姓名,再把他们从老人身边引开。"
     ]
    },
    {
     "title": "第三章 · 子爵的故事",
     "type": "prose",
     "paragraphs": [
      "安娜·帕夫洛夫娜的招待会正进行得热火朝天。四下里,纺锤似的话语嗡嗡作响,绵绵不绝。除了姑妈身边只坐着一位面容清瘦憔悴、在这华贵场面中显得有些格格不入的老妇人之外,满座宾客已分成了三堆。",
      "那位子爵是个相貌俊秀的年轻人,五官柔和,举止优雅,显然自视为名流,却又出于礼貌,谦逊地任凭这个圈子摆布。安娜·帕夫洛夫娜分明是把他当作一道珍馐,端出来款待宾客的。",
      "“啊,对了!子爵,把那件事原原本本讲给我们听吧,”安娜·帕夫洛夫娜说,心里美滋滋地觉得这句话听来颇有几分路易十五时代的味道。"
     ]
    }
   ],
   "edition": "中译本 · 外国文学"
  },
  {
   ...
   "author": "列夫·托尔斯泰",
   "category": "fiction",
   "blurb": "安娜对沃伦斯基的炽烈情爱,在俄国上流社会的广阔背景下一步步走向毁灭。",
   "words": 621,
   "chapters": [
    {
     "title": "第一章",
     ...
     "paragraphs": [
      ...
      "奥布隆斯基家里一片混乱。妻子发觉丈夫和家里先前那位法国籍家庭女教师有了私情,便向丈夫声明,她无法再同他在一个屋檐下生活下去。",
      "这场争吵过后三天,斯捷潘·阿尔卡季奇·奥布隆斯基公爵——社交场上人称“斯季瓦”——照常在早晨八点钟醒来,却不是在妻子的卧室,而是在自己书房那张蒙着皮面的沙发上。"
     ]
    },
    {
     "title": "第二章",
     "type": "prose",
     "paragraphs": [
      "斯捷潘·阿尔卡季奇对自己一向诚实。他没法欺骗自己,硬说自己悔恨方才的所作所为。",
      "“唉,糟透了!天哪,天哪!糟透了!”斯捷潘·阿尔卡季奇反复念叨着,却想不出半点法子。“可在这之前,一切原本那么顺当!我们过得多好啊!”",
      "没有别的出路,只有生活赋予一切难题——哪怕最复杂、最无解的难题——的那个万能答案。那答案就是:人得过好眼前的日子,也就是说,忘掉自己。"
     ]
    },
    {
     "title": "第三章",
     "type": "prose",
     "paragraphs": [
      "穿戴停当,斯捷潘·阿尔卡季奇往身上洒了些香水,拉了拉衬衫的袖口,把香烟、钱夹、火柴和那只带双链坠饰的怀表分别装进口袋,又抖开手帕。他觉得自己干净、芬芳、康健、周身舒泰——尽管心里并不痛快——便迈着轻快的步子走进餐厅。那里咖啡早已备好,旁边还放着办公室送来的信件和文书。",
      "他读起信来。有一封很叫人不快,是一个想买下他妻子名下那片林子的商人写来的。那片林子非卖不可;可眼下,在同妻子和解之前,这件事根本无从谈起。",
      "看完信,斯捷潘·阿尔卡季奇把公文挪到跟前,飞快地翻阅了两桩事务,用粗铅笔批了几行字,随即把文书推开,端起咖啡。他一边啜着咖啡,一边摊开还带潮气的晨报,读了起来。"
     ]
    }
   ],
   "edition": "中译本 · 外国文学"
  },
  {
   ...
   "author": "福楼拜",
   "category": "fiction",
   "blurb": "外省医生的妻子沉溺于浪漫幻想,渐渐陷入债务与毁灭——法国现实主义的极致之作。",
   "words": 521,
   "chapters": [
    {
     "title": "第一章 · 新来的",
     "type": "prose",
     "paragraphs": [
      "那个“新来的”站在门后的角落里,几乎叫人瞧不见。他是个乡下少年,约莫十五岁,个头比我们谁都高。头发齐着前额剪得方方正正,像村里教堂的歌童;模样老实,却显得很不自在。",
      "我们开始背书。他竖起耳朵听着,专注得像在听布道,连腿也不敢翘一翘,胳膊也不敢支一支;两点钟铃响时,还得老师吩咐一声,他才肯同我们一道排进队里。",
      "重新上课时,我们照例把帽子往地上一扔,好腾出手来;我们惯于一进门就把帽子往课桌底下一甩,叫它撞在墙上,扬起一大片灰尘:这才算“有派头”。"
     ]
    },
    {
     "title": "第二章",
     "type": "prose",
     "paragraphs": [
      "“把你那顶头盔摘了吧,”老师说道——他也有几分爱打趣。",
      "孩子们哄堂大笑,弄得这可怜的少年狼狈不堪,简直不知该把帽子拿在手里,还是搁在地上,还是戴到头上。他重又坐下,把帽子搁在膝头。",
      "“站起来,”老师又说,“把你的名字告诉我。”"
     ]
    },
    {
     ...
     "type": "prose",
     "paragraphs": [
      "那“新来的”于是下了天大的决心,张开一张大得出奇的嘴,扯着嗓子喊出一个词,仿佛在叫唤谁似的——“夏包法利”。",
      "一阵喧闹爆发开来,越闹越响,夹着尖利的嗓音:他们又喊又叫、跺脚不止,反复嚷着“夏包法利!”",
      "然而,在一连串罚抄之中,课堂秩序渐渐恢复了。老师好不容易听清了“夏尔·包法利”这个名字,又叫人一字一字念给他、拼给他、再读一遍,当即喝令这倒霉的家伙到讲台脚下的“罚坐凳”上去坐着。"
     ]
    }
   ],
   "edition": "中译本 · 外国文学"
  },
  {
   ...
   "author": "大仲马",
   "category": "fiction",
   "blurb": "蒙冤入狱的唐戴斯越狱寻得巨额宝藏,化身基督山伯爵,展开一场精心编织的复仇。",
   "words": 636,
   "chapters": [
    {
     "title": "第一章 · 法老号归港",
     "type": "prose",
     "paragraphs": [
      "一八一五年二月二十四日,守望圣母院的瞭望员发出信号,报告三桅船“法老号”到港——它来自士麦那、的里雅斯特和那不勒斯。",
      "照例,一名引水员立即出海,绕过伊夫堡,在摩尔吉永角和里翁岛之间登上了那条船。",
      "转眼之间,圣约翰堡的城墙上照例挤满了看热闹的人;在马赛,一条船进港总是一桩大事,何况这条船——像“法老号”这样——是在古老的福西亚船坞里建造、装配、装货的,船主又是本城的人。"
     ]
    },
    {
     "title": "第二章 · 父与子",
     "type": "prose",
     "paragraphs": [
      "我们暂且撇下与仇恨这恶魔搏斗、正竭力在船主耳边挑唆、给同伴栽些邪疑的腾格拉尔,去跟着唐戴斯。他穿过卡纳比埃尔大街,折入诺阿耶街,走进梅朗林荫道左侧一所小屋,飞快地登上一道昏暗的楼梯,一手扶着栏杆,一手按住怦怦直跳的心,在一扇半掩的门前停住——从门缝里,他能望见那间小屋的全貌。",
      "住在这间屋里的,是唐戴斯的父亲。“法老号”到港的消息还没传到老人耳中。他正站在一把椅子上,用颤抖的手摆弄着窗前棚架上攀爬的旱金莲和铁线莲,自得其乐。",
      "老人惊叫一声,转过身来;一见是儿子,便扑进他怀里,脸色煞白,浑身发抖。"
     ]
    },
    {
     "title": "第三章 · 加泰罗尼亚人的村子",
     "type": "prose",
     "paragraphs": [
      "在一堵光秃秃、被风雨剥蚀的墙外,离这两位朋友坐着饮酒、看着听着的地方约莫百步之遥,便是加泰罗尼亚人的村子。很久以前,这个神秘的族群离开西班牙,定居在这片至今仍属于他们的狭长地角上。",
      "请读者随我们走上这小村唯一的街道,同我们一道走进其中一所屋子。屋子的外墙被太阳晒成了当地建筑特有的、美丽的枯叶色,里面则像西班牙小客栈那样刷着白灰。",
      "“你瞧,梅尔塞苔丝,”年轻人说,“复活节又到了;告诉我,眼下不正是办喜事的时候吗?”"
     ]
    }
   ],
   "edition": "中译本 · 外国文学"
  },
  {
   ...
   "author": "卡夫卡",
   "category": "fiction",
   "blurb": "格里高尔一觉醒来变成巨大的甲虫——一则关于异化、孤独与亲情的现代寓言。",
   "words": 657,
   "chapters": [
    {
     "title": "第一章",
     "type": "prose",
     "paragraphs": [
      "一天清晨,格里高尔·萨姆莎从一场不安的睡梦中醒来,发现自己在床上变成了一只硕大可怕的甲虫。他仰面躺着,背壳坚硬如铠甲;略一抬头,便看见自己那隆起的、棕褐色的肚子,上面被一道道弧形的硬棱分成了一节一节。",
      "“我这是怎么了?”他想。这并不是梦。他那间房——一间地道的人住的房间,只是略嫌窄小——仍旧安静地躺在四堵熟悉的墙壁之间。",
      "格里高尔随即转眼望向窗外阴沉的天色。雨点敲打窗玻璃的声音听得分明,叫他心里好不凄凉。"
     ]
    },
    {
     "title": "第二章",
     "type": "prose",
     "paragraphs": [
      "他朝五斗橱上滴答作响的闹钟望去。“我的天哪!”他想。已经六点半了,指针还在静静地往前走,甚至过了半点,快到七点差一刻了。难道闹钟没响过?",
      "他还在匆匆把这一切盘算着,拿不定主意要不要起床,这时钟敲了七点差一刻。床头边的门上传来小心翼翼的敲门声。“格里高尔,”有人唤道——是母亲——“七点差一刻啦。你不是要出门吗?”那温柔的声音!",
      "他最想做的,是安安静静、不受打扰地起身,穿好衣裳,尤其是先吃上早饭。之后再考虑下一步怎么办;他心里明白,赖在床上是断断理不出什么像样的主意来的。"
     ]
    },
    {
     "title": "第三章",
     "type": "prose",
     "paragraphs": [
      "于是他试着先把上半身挪下床去,小心地把头扭向一侧。这一下倒挺顺当;尽管身子又宽又重,那庞大的躯体终究还是慢慢跟着头的方向移了过来。",
      "要退回原先的位置,也一样费劲;可当他躺在那儿喘着气,重又看着自己那些腿比先前更凶地彼此乱蹬时——倘若那还能更凶的话——他实在想不出有什么法子能让这一团混乱安定下来、归于秩序。",
      "但他随即对自己说:“七点一刻敲响之前,我无论如何得彻底下床才行。再说到那时,公司里多半也会有人来问我出了什么事,因为他们七点前就开门了。”"
     ]
    }
   ],
   "edition": "中译本 · 外国文学"
  },
  {
   ...
   "author": "安德鲁·朗 辑",
   "category": "fiction",
   "blurb": "山鲁佐德以一千零一夜的神灯、飞毯与航海奇谭,为自己、也为天下女子换取生机。",
   "words": 512,
   "chapters": [
    {
     "title": "第一章 · 萨珊王的故事",
     "type": "prose",
     "paragraphs": [
      "在萨珊王朝的古老编年史里——这个王朝绵延约四百年,疆域从波斯一直伸展到中国边境,远及恒河彼岸——记载着这一族中一位国王的颂辞,据说他是当时最贤明的君主。",
      "他身后留下的两个儿子手足情深。只是帝国的律法不许长子沙赫里亚尔与弟弟分享疆土,这叫做哥哥的着实伤心。",
      "国王因爱妃背叛而心灰意冷,从此立下一条狠毒的规矩:每夜娶一位新娘,天明便将她处死,免得再受欺骗。全国上下,人心惶惶。"
     ]
    },
    {
     "title": "第二章 · 宰相的女儿",
     "type": "prose",
     "paragraphs": [
      "那位宰相本人是两个女儿的父亲:长女名叫山鲁佐德,幼女名叫敦亚佐德。敦亚佐德并无过人之处,与寻常女子无异;她的姐姐却聪慧过人、胆识超群。",
      "一天,宰相正同他这位心爱的、引以为傲的长女说话,山鲁佐德对他说:“父亲,我有一事相求,您肯应允吗?”",
      "“只要合情合理,我没有什么不能答应你的,”他回答。"
     ]
    },
    {
     "title": "第三章 · 自愿为后",
     "type": "prose",
     "paragraphs": [
      "“父亲,”山鲁佐德答道,“每天要为苏丹献上一位新娘的,正是您;我恳求您,看在您对我的疼爱份上,让这桩差事落到我身上吧。”",
      "“你疯了不成?”宰相骇然倒退一步,叫道,“是什么叫你起了这等念头?到这会儿,你该明白做苏丹的新娘意味着什么了吧!”",
      "“是的,父亲,我深知其中利害,”她回答,“可我并不怕去想它。倘若我失败了,我的死也是光荣的;倘若我成功了,我便为我的祖国立下了一桩大功。”"
     ]
    }
   ],
   "edition": "中译本 · 外国文学"
  },
  {
   ...
   "author": "曹雪芹",
   "category": "fiction",
   "blurb": "賈寶玉與林黛玉、薛寶釵的情緣興衰,寫盡一個鐘鳴鼎食之家的繁華與幻滅。",
   "words": 740,
   "chapters": [
    {
     "title": "第一回甄士隱夢幻識通靈賈雨村風塵怀閨秀",
     "type": "prose",
     "paragraphs": [
  ...
  },
  {
   ...
   "author": "羅貫中",
   "category": "fiction",
   "blurb": "漢末群雄並起,魏蜀吳三分天下,英雄豪傑與權謀征伐的千古史詩。",
   "words": 1076,
   "chapters": [
    {
  ...
  },
  {
   ...
   "author": "吳承恩",
   "category": "fiction",
   "blurb": "孫悟空護送唐僧西天取經,歷九九八十一難,降妖伏魔的神魔奇譚。",
   "words": 909,
   "chapters": [
    {
     "title": "第一回靈根育孕源流出心性修持大道生",
     "type": "prose",
     "paragraphs": [
      "混沌未分天地亂，茫茫渺渺無人見。",
      "自從盤古破鴻濛，開闢從茲清濁辨。",
  ...
  },
  {
   ...
   "author": "施耐庵",
   "category": "fiction",
   "blurb": "一百零八位好漢聚義梁山,替天行道,寫盡亂世逼上梁山的悲壯。",
   "words": 1096,
   "chapters": [
    {
     "title": "第一回王教頭私走延安府九紋龍大鬧史家村",
     "type": "prose",
     "paragraphs": [
    ...
    {
     "title": "第二回史大郎夜走華陰縣魯提轄拳打鎮關西",
     "type": "prose",
     "paragraphs": [
      "話說當時史進道：「卻怎生是好？」朱武等三個頭領跪下道：「哥哥，你是乾淨",
      "的人，休爲我等連累了。大郎可把索來綁縛我三個出去請賞，免得負累了你不好看。",
      "」史進道：「如何使得！恁地時，是我賺你們來，捉你請賞，枉惹天下人笑。若是死",
      "時，我與你們同死；活時同活。你等起來，放心，別作圓便。且等我問個來歷情繇。",
      "史進上梯子問道：「你兩個何故半夜三更來劫我莊上？」兩個都頭道：「大郎，",
      "你兀自賴哩！見有原告人李吉在這裏。」史進喝道：「李吉，你如何誣告平人？」李"
     ]
    },
    {
     "title": "第三回趙員外重修文殊院魯智深大鬧五臺山",
     "type": "prose",
     "paragraphs": [
      "話說當下魯提轄扭過身來看時，拖扯的不是別人，卻是渭州酒樓上救了的金老。",
      "那老兒直拖魯達到僻靜處，說道：「恩人！你好大膽！見今明明地張掛榜文，出一千",
      "貫賞錢捉你，你緣何卻去看榜？若不是老漢遇見時，卻不被做公的拿了？榜上見寫著",
      "你年甲，貌相，貫址！」魯達道：「洒家不瞞你說，因爲你事，就那日回到狀元橋下",
      "，正迎著鄭屠那廝，被洒家三拳打死了，因此上在逃。一到處撞了四五十日，不想來",
      "到這裏。你緣何不回東京去，也來到這裏？」金老道：「恩人在上；自從得恩人救了"
     ]
    },
    {
     "title": "第四回小霸王醉入銷金帳花和尚大鬧桃花村",
     "type": "prose",
     "paragraphs": [
      "話說當日智真長老道：「智深，你此間決不可住了。我有一個師弟，見在東京大",
      "相國寺住持，喚做智清禪師。我與你這封書去投他那裏討個職事僧做。我夜來看了，",
      "贈汝四句偈子，你可終身受用，記取今日之言。」智深跪下道：「洒家願聽偈子。」",
      "長老道：「遇林而起，遇山而富，遇州而遷，遇江而止。」魯智深聽了四句偈子，拜",
      "了長老九拜，背了包裹，腰包，肚包，藏了書信，辭了長老并衆僧人，離了五臺山，",
      "逕到鐵匠間壁客店裏歇了，等候打了禪杖，戒刀完備就行。寺內衆僧得魯智深去了，"
     ]
    },
    {
     "title": "第五回九紋龍翦徑赤松林魯智深火燒瓦官寺",
     "type": "prose",
     "paragraphs": [
      "話說魯智深走過數個山坡，見一座大松林，一條山路；隨著那山路行去，走不得",
      "半裏，擡頭看時，卻見一所敗落寺院，被風吹得鈴鐸響；看那山門時，上有一面舊朱",
      "紅牌額，內有四個金字，都昏了，寫著「瓦官之寺。」又行不得四五十步，過座石橋",
      "，入得寺來，便投知客寮去。只見知客寮門前，大門也沒了，四圍壁落全無。智深尋",
      "思道：「這個大寺如何敗落得恁地？」直入方丈前看時，只見滿地都是燕子糞，門上",
      "一把鎖鎖著，鎖上儘是蜘蛛網。智深把禪杖就地下搠著，叫道：「過往僧人來投齋。"
     ]
    }
   ]
  },
  {
   ...
   "author": "白行簡",
   "category": "fiction",
   "blurb": "唐傳奇名篇:滎陽公子與長安名妓李娃的離合悲歡,情義動人。",
   "words": 1140,
   "chapters": [
    {
     "title": "第1節",
     "type": "prose",
     "paragraphs": [
      "汧國夫人李娃﹐長安之倡女也。節行瑰奇﹐有足稱者。故監察御史向行簡為傳述。天寶",
      "中﹐有常州刺史滎陽公者﹐略其名氏﹐不書﹐時望甚崇﹐家徒甚慇。知命之年﹐有一子",
      "﹐始弱冠矣﹐雋朗有詞藻﹐迥然不群﹐深為時輩推伏。其父愛而器之﹐曰﹕“此吾家千",
      "里駒也。”應鄉賦秀才舉﹐將行﹐乃盛其服玩車馬之飾﹐計其京師薪儲之費。謂之曰﹕",
      "“吾觀爾之才﹐當一戰而霸。今備二載之用﹐且豐爾之給﹐將為其志也。”生亦自負視",
      "上第如指掌。自毗陵發﹐月余抵長安﹐居于布政裡。嘗游東市還﹐自平康東門入﹐將訪"
     ]
    },
    {
     "title": "第2節",
     "type": "prose",
     "paragraphs": [
      "友于西南。至鳴珂曲﹐見一宅﹐門庭不甚廣﹐而室宇嚴邃﹐闔一扉。有娃方憑一雙鬟青",
      "衣立﹐妖姿要妙﹐絕代未有。生忽見之﹐不覺停驂久之﹐徘徊不能去。乃詐墜鞭于地﹐",
      "候其從者﹐敕取之﹐累眄于娃﹐娃回眸凝睇﹐情甚相慕﹐竟不敢措辭而去。生自爾意若",
      "有失﹐乃密征其友游長安之熟者以訊之。友曰﹕“此狹邪女李氏宅也。”曰﹕“娃可求",
      "乎﹖”對曰﹕“李氏頗贍﹐前與通之者﹐多貴戚豪族﹐所得甚廣﹐非累百萬﹐不能動其",
      "志也。”生曰﹕“苟患其不諧﹐雖百萬﹐何惜﹗”他日﹐乃潔其衣服﹐盛賓從而往。扣"
     ]
    },
    {
     "title": "第3節",
     "type": "prose",
     "paragraphs": [
      "其門﹐俄有侍兒啟扃。生曰﹕“此誰之第耶﹖”侍兒不答﹐馳走大呼曰﹕“前時遺策郎",
      "也。”娃大悅曰﹕“爾姑止之﹐吾當整妝易服而出。”生聞之﹐私喜。乃引至蕭牆間﹐",
      "見一姥垂白上僂﹐即娃母也。生跪拜前致詞曰﹕“聞茲地有隙院﹐願稅以居﹐信乎﹖”",
      "姥曰﹕“懼其淺陋湫隘﹐不足以辱長者所處﹐安敢言直耶﹖”延生于遲賓之館﹐館宇甚",
      "麗。與生偶坐﹐因曰﹕“某有女嬌小﹐技藝薄劣﹐欣見賓客﹐願將見之。”乃命娃出﹐",
      "明眸皓腕﹐舉步艷冶。生遂驚起﹐莫敢仰視。與之拜畢﹐敘寒燠﹐觸類妍媚﹐目所未睹"
     ]
    },
    {
     "title": "第4節",
     "type": "prose",
     "paragraphs": [
      "。復坐﹐烹茶斟酒﹐器用甚潔。久之日暮﹐鼓聲四動。姥訪其居遠近。生之曰﹕“在",
      "延平門外數裡。”冀其遠而見留也。姥曰﹕“鼓已發矣﹐當速歸﹐無犯禁。”生曰﹕“",
      "幸接歡笑﹐不知日之雲夕。道裡遼闊﹐城內又無親戚﹐將若之何﹖”娃曰﹕“不見責僻",
      "陋﹐方將居之﹐宿何害焉。”生數目姥﹐姥曰﹕“唯唯。”生乃召其家僮﹐持雙縑﹐請",
      "以備一宵之饌。娃笑而止之曰﹕“賓主之儀﹐且不然也。今夕之費﹐願以貧窶之家﹐隨",
      "其粗以進之。其餘以俟他辰。”固辭﹐終不許。俄徙坐西堂﹐帷幕帘榻﹐煥然奪目﹔妝"
     ]
    },
    {
     "title": "第5節",
     "type": "prose",
     "paragraphs": [
      "奩衾枕。亦皆侈麗。乃張燭進饌﹐品味甚盛。徹饌﹐姥起。生娃談話方切﹐詼諧調笑﹐",
      "無所不至。生曰﹕“前偶過卿門﹐遇卿適在屏間。厥後心常勤念﹐雖寢與食﹐未嘗或舍",
      "。”娃答曰﹕“我心亦如之。”生曰﹕“今之來﹐非直求居而已﹐願償平生之志。但未",
      "知命也若何。”言未終﹐姥至﹐詢其故﹐具以告。姥笑曰﹕“男女之際﹐大欲存焉。情",
      "苟相得﹐雖父母之命﹐不能制也。女子固陋﹐曷足以荐君子之枕蓆﹗”生遂下階﹐拜而",
      "謝之曰﹕“願以己為養。”姥遂目之為郎﹐飲酣而散。及旦﹐盡徙其囊橐﹐因家于李之"
     ]
    }
   ]
  },
  {
   ...
   "author": "老子",
   "category": "philosophy",
   "blurb": "八十一章,論「道」與「德」、無為與柔弱,中國思想的源頭活水。",
   "words": 382,
   "chapters": [
    {
     "title": "第一章",
  ...
  },
  {
   ...
   "author": "孔子及弟子",
   "category": "philosophy",
   "blurb": "孔門師徒的言行語錄,仁、禮、學、政,塑造東亞兩千年的處世之道。",
   "words": 1107,
   "chapters": [
    {
     "title": "學而第一",
  ...
  },
  {
   ...
   "author": "列禦寇",
   "category": "philosophy",
   "blurb": "道家寓言集:愚公移山、杞人憂天、夸父逐日,以奇想說玄理。",
   "words": 955,
   "chapters": [
    {
     "title": "第1節",
     ...
     "paragraphs": [
      "卷第一天瑞篇",
      "子列子居鄭圃，四十年人無識者．國君卿大夫視之，猶眾庶也．國不足，將嫁於",
      "衛．弟子曰：「先生往無反期，弟子敢有所謁；先生將何以教？先生不聞壺丘",
      "子林之言乎？」子列子笑曰：「壺子何言哉？雖然，夫子嘗語伯昏瞀人．吾側聞",
      "均A試以告女．其言曰：有生不生，有化不化．不生者能生生，不化者能化化．",
    ...
    },
    {
     ...
     "paragraphs": [
      ...
      "《黃帝書》曰：『谷神不死，是謂玄牝．玄牝之門，是謂天地之根．綿綿若存，",
      "用之不勤．』故生物者不生，化物者不化．自生自化，自形自色，自智自力，",
      "自消自息．謂之生化形色智力消息者，非也．",
      "子列子曰：「昔者聖人因陰陽以統天地．夫有形者生於無形，則天地安從生？故",
      "曰：有太易，有太初，有太始，有太素．太易者，未見氣也；太初者，氣之始也"
     ]
    },
    {
     "title": "第3節",
     "type": "prose",
     "paragraphs": [
      "；太始者，形之始也；太素者，質之始也．氣形質具而未相離，故曰渾淪．",
      "渾淪者，言萬物相渾淪而未相離也．視之不見，聽之不聞，循之不得，故曰易也",
      "．易無形埒，易變而為一，一變而為七，七變而為九．九變者，究也；乃復變而",
      "陘@．一者，形變之始也．清輕者上為天，濁重者下為地，沖和氣者為人；故天地",
      "含精，萬物化生．」",
      "子列子曰：「天地無全功，聖人無全能，萬物無全用．故天職生覆，地職形載，"
     ]
    },
    {
     "title": "第4節",
     "type": "prose",
     "paragraphs": [
      "聖職教化，物職所宜．然則天有所短，地有所長，聖有所否，物有所通．何則？",
      "生覆者不能形載，形載者不能教化，教化者不能違所宜，宜定者不出所位．故天",
      "地之道，非陰則陽；聖人之教，非仁則義；萬物之宜，非柔則剛：此皆隨所宜而",
      "不能出所位者也．故有生者，有生生者；有形者，有形形者；有聲者，有聲聲者",
      "；有色者，有色色者；有味者，有味味者．生之所生者死矣，而生生者皆未嘗終",
      "；形之所形者實矣，而形形者未嘗有；聲之所聲者聞矣，而聲聲者未嘗發；色"
     ]
    },
    {
     "title": "第5節",
     "type": "prose",
     "paragraphs": [
      "妝狾滫拊矣，而色色者未嘗顯；味之所味者嘗矣，而味味者未嘗呈：皆無為之職",
      "也．能陰能陽，能柔能剛，能短能長，能員能方，能生能死，能暑能涼，能浮能",
      "沈，能宮能商，能出能沒，能玄能黃，能甘能苦，能羶能香．無知也，無能也，",
      "而無不知也，而無不能也．」",
      "子列子適衛，食於道，從者見百歲髑髏，攓蓬而指，顧謂弟子百豐曰：「唯予與",
      "憚齒茈撕薔穸撕薯漱]．此過養乎？此過歡乎？」種有幾：得水為藚，得水土之際"
     ]
    }
   ]
  },
   ...
   "chapters": [
    {
     ...
     "paragraphs": [
      ...
      "这样的单身汉,每逢新搬到一个地方,四邻八舍虽然完全不了解他的性情如何、见解如何,可是,既然这样一条真理早已在人们心目中根深蒂固,大家便总把他看作自己某一个女儿理所应得的一笔财产。",
      "“我亲爱的班纳特先生,”有一天班纳特太太对她丈夫说,“你有没有听说,尼日斐花园终于租出去了?”"
     ]
    },
    {
     "title": "第二章",
     "type": "prose",
     "paragraphs": [
      "班纳特先生其实是最先去拜访彬格莱先生的人之一。他一向打算去拜访,只是嘴上始终对太太咬定不去;直到拜访后的第二天傍晚,太太才知道实情。事情是这样揭穿的。",
      "“但愿彬格莱先生会喜欢这顶帽子,丽萃。”",
      "“既然我们不打算去拜访彬格莱先生,”做母亲的悻悻地说,“我们又怎么会知道他喜欢什么。”"
     ]
    },
    {
     "title": "第三章",
     "type": "prose",
     "paragraphs": [
      "尽管班纳特太太有五个女儿帮腔,可无论她怎样向丈夫盘问,都套不出一句关于彬格莱先生像样的描述来。",
      "“只要能看到一个女儿在尼日斐花园幸福地安顿下来,”班纳特太太对丈夫说,“其余几个也都嫁得一样称心,我这辈子就再无所求了。”",
      "没过几天,彬格莱先生回访了班纳特先生,在他书房里坐了约莫十分钟。他原指望能见一见几位小姐——早就听说她们的美貌——可结果只见到了她们的父亲。"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "叫我以实玛利吧。若干年前——别管究竟多少年——我囊中羞涩,岸上也没什么特别让我留恋的,便想出海航行一番,去见识见识这世界上属于水的那一部分。这是我驱散胸中郁闷、调理周身血脉的法子。",
      "瞧,这便是你们曼哈顿人的海岛之城,四围被一道道码头环抱,如同珊瑚礁环抱着印第安群岛——商业的浪潮把它团团围住。街道无论向左向右,都把你引向水边。",
      "在一个梦幻般的安息日午后,绕着这座城走一圈吧。从科利尔斯胡克走到科恩蒂斯滑坡,再由白厅一路向北。你看见了什么?——成千上万的凡人,像一个个沉默的哨兵,伫立在全城各处,出神地凝望着大海。"
     ]
    },
    {
     "title": "第二章 · 旅行袋",
     "type": "prose",
     "paragraphs": [
      "我把一两件衬衫塞进那只旧毛毡提包,往胳膊下一夹,便朝着合恩角和太平洋出发了。我离开古老的曼哈托好城,如期到了新贝德福。那是十二月里的一个星期六夜晚。",
      "既然大多数立志去尝那捕鲸之苦的年轻人,都要在这同一个新贝德福歇脚,再从这里启程出海,那不妨交代一句:我本人当初压根儿没打算这么做。",
      "眼下,在我能动身前往目的港之前,还得在新贝德福捱过一夜、一天、再加一夜,于是这期间在哪儿吃、在哪儿睡,便成了一桩要紧事。那是个十分可疑、不,十分阴沉惨淡的夜晚,冷得刺骨,毫无暖意。"
     ]
    },
    {
     "title": "第三章 · 喷水客栈",
     "type": "prose",
     "paragraphs": [
      "一走进那家山墙高耸的“喷水客栈”,你就置身于一道又宽又矮、歪歪斜斜的过道里,墙上镶着老式护壁板,叫人想起某条被判了死刑的破船的舷墙。",
      "然而最叫你摸不着头脑、困惑不已的,是画幅正中那一团又长又软、凶兆般黑乎乎的东西,它悬浮在三条幽蓝、隐约、垂直的线条之上,而那些线条又浮在一片无以名状的浑浊里。这真是一幅烂糟糟、湿漉漉、黏答答的画,足以把神经脆弱的人逼疯。",
      "其实,那画家的用意似乎是这样的——这是我自己最后琢磨出的一套见解,部分根据我就此事请教过的许多上了年纪的人的意见综合而来。"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "爱丽丝陪姐姐坐在河岸上,无所事事,开始觉得厌倦极了。她一两回偷偷瞄了瞄姐姐读的那本书,可书里既没有图画,也没有对话,“一本书既没图画又没对话,”爱丽丝想,“那还有什么用呢?”",
      "于是她在心里盘算起来(这大热天弄得她昏昏欲睡、迷迷糊糊,她也只能勉强思量):编一只雏菊花环的乐趣,值不值得她爬起来去采雏菊。就在这时,一只粉红眼睛的白兔忽地从她身边跑过。",
      "这本没什么稀奇;爱丽丝听见那兔子自言自语地说“哎呀!哎呀!我要迟到了!”,也并不觉得有多出奇。"
     ]
    },
    {
     "title": "第二章 · 眼泪的池塘",
     "type": "prose",
     "paragraphs": [
      "“越来越奇怪了!”爱丽丝叫道(她惊讶得连话都一时说不利索了),“现在我像世上最大的望远镜一样越拉越长啦!再见了,我的脚!”",
      "她接着盘算起来:这事该怎么办才好。“得托人捎去才行,”她想,“给自己的脚寄礼物,这该多滑稽!那地址写起来又该多古怪!”",
      "壁炉边地毯近旁,爱丽丝小姐的右脚台启——附爱丽丝的爱。"
     ]
    },
    {
     "title": "第三章 · 一场会议式赛跑",
     "type": "prose",
     "paragraphs": [
      "聚在岸上的,的确是一群模样古怪的伙伴——羽毛湿淋淋的鸟儿,皮毛紧贴在身上的走兽,个个浑身滴水,又恼又难受。",
      "头一个问题当然是:怎样才能把身子弄干。它们就此商量了一番;不过几分钟,爱丽丝便觉得同它们这样熟稔地交谈再自然不过,仿佛她一辈子都认识它们似的。",
      "最后,那只在它们中间似乎颇有威望的老鼠喊道:“都坐下,听我说!我马上就能叫你们干透!”大家立刻围成一个大圈坐了下来,老鼠居中。"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "在歇洛克·福尔摩斯心目中,她永远是“那位女人”。我极少听他用别的称呼提起她。在他眼里,她的光彩盖过、压倒了她整个性别。这并不是说他对艾琳·艾德勒怀有什么近乎爱情的感情。",
      "近来我很少见到福尔摩斯。我的婚姻使我们彼此疏远了。",
      "一天夜里——那是一八八八年三月二十日——我出诊归来(那时我已重操旧业,当起了私人医生),路恰好经过贝克街。"
     ]
    },
    {
     "title": "波希米亚丑闻 · 二",
     "type": "prose",
     "paragraphs": [
      "三点整,我准时到了贝克街,可福尔摩斯还没回来。房东太太告诉我,他早晨八点刚过就出门了。我还是在炉火旁坐了下来,打定主意要等他,无论他要去多久。",
      "快到四点时,门开了,一个醉醺醺的马夫走进屋来——蓬头垢面,留着络腮胡,满脸通红,衣衫褴褛。",
      "“嘿,真没想到!”他喊了一声,随即一阵哽咽,接着又大笑起来,直笑得瘫软无力地往椅背上一靠。"
     ]
    },
    {
     "title": "波希米亚丑闻 · 三",
     "type": "prose",
     "paragraphs": [
      "那天夜里我就睡在贝克街。第二天早晨,我们正吃着烤面包、喝着咖啡,波希米亚国王就闯进了屋子。",
      "“你当真把它弄到手了!”他抓住福尔摩斯的双肩,急切地盯着他的脸,叫道。",
      "“那就走吧。我已经急不可耐了。”"
     ]
    }
   ],
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "我写下这些文字——写于印度——寄给我在英国的亲属。",
      "我的用意,是要说明我为何拒绝向表弟约翰·赫恩卡斯尔伸出友谊之手。我在此事上一向缄默,却被家中某些人误解了;而他们的好评,我是不愿失去的。",
      "我与表弟之间这桩私人嫌隙,起因于一桩我们二人都牵涉其中的重大公共事件——一七九九年五月四日,贝尔德将军麾下对塞林伽巴丹的强攻。"
     ]
    },
    {
     "title": "第一章",
     "type": "prose",
     "paragraphs": [
      "在《鲁滨逊漂流记》第一部第一百二十九页上,你会读到这样一句话:",
      "“如今我看出来了,只是太迟——做一件事之前不先估量代价、不先掂量自己能否有力量做到底,真是愚蠢。”",
      "就在昨天,我把《鲁滨逊漂流记》翻到了那一页。也就在今天早晨(一八五〇年五月二十一日),我家夫人的外甥富兰克林·布莱克先生来了,同我作了一番短短的谈话,如下:"
     ]
    },
    {
     "title": "第二章",
     ...
     "paragraphs": [
      "方才我提到了我家夫人。",
      "倘若你对上流社会略知一二,准听说过赫恩卡斯尔家三位美丽的小姐:阿德莱德小姐、卡罗琳小姐和茱莉亚小姐——依我看,这最后一位最小,也是三姐妹中最好的一个;而我是有机会评判的,这一点你往下看便知。",
      "我忘了交代:我跟着新娘子来到了这位新郎在乡下的宅邸和田庄。“约翰爵士,”她说,“没有加百列·贝特里奇我可不行。”“夫人,”约翰爵士说,“我也少不了他。”他对她向来如此——我就是这样进了他家当差的。"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "福尔摩斯先生那天早晨坐在早餐桌旁。他通常起得很迟,除非碰上那种通宵不眠的场合——这倒也不算少见。我站在壁炉前的地毯上,拾起昨夜那位访客落下的手杖。",
      "福尔摩斯背对着我坐着,我并没有让他看出我在做什么。",
      "“你怎么知道我在干什么?我看你脑后是不是也长了眼睛。”"
     ]
    },
    {
     "title": "第二章 · 巴斯克维尔的祸祟",
    ...
    },
    {
     ...
     "type": "prose",
     "paragraphs": [
      "听到这话,我承认不禁打了个寒噤。医生话音里有一种激动,显出他自己也被所讲的事深深打动了。福尔摩斯兴奋地把身子往前一探,两眼射出那种他兴趣浓厚时特有的、冷峻而干涩的光。",
      "“那些脚印离尸体约莫二十码,谁也没把它放在心上。要不是我知道这桩传说,恐怕我自己也想不到。”",
      "“那里有两排古老的紫杉树篱,高十二英尺,密不透风。中间那条小径约莫八英尺宽。”"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "时间旅行者(姑且这样称呼他,以图方便)正向我们阐述一个深奥的问题。他那双灰眼睛闪闪发亮,平日苍白的脸此刻泛着红光,神采奕奕。",
      "“你们必须仔细听我说。我要驳斥一两个几乎人人都奉为圭臬的观念。比方说,你们在学校里学的几何学,就建立在一个误解之上。”",
      "“一上来就要我们接受这么大的论断,是不是太过分了?”红头发的费尔比说——他是个爱抬杠的人。"
     ]
    },
    {
     "title": "第二章",
     "type": "prose",
     "paragraphs": [
      "时间旅行者手里拿着的,是一具闪闪发光的金属小架子,比一只小钟大不了多少,做工极其精巧。上面有象牙,还有某种透明的水晶似的物质。",
      "时间旅行者看看我们,又看看那机械。“怎么样?”心理学家问。",
      "“这小玩意儿,”时间旅行者把双肘支在桌上,两手在那仪器上方合拢,说道,“只是个模型。它是我那台穿越时间的机器的设计图。”"
     ]
    },
    {
     "title": "第三章",
     "type": "prose",
     "paragraphs": [
      "我想,那时候我们谁都不大相信那台时间机器。事实是,时间旅行者属于那种聪明得叫人不敢轻信的人:你从不觉得自己把他看了个透;在他清澈坦率的外表背后,你总疑心藏着某种微妙的保留、某种埋伏着的机巧。",
      "下一个星期四,我又去了里士满——我大概是时间旅行者最常来的客人之一——到得晚了,发现客厅里已聚了四五个人。那位医生站在炉火前,一手拿着一张纸,一手握着怀表。",
      "“你才到?真有点怪。他被什么事绊住了,脱不开身。他在这张便条里要我先张罗着,若七点他还没回来,就请大家先用晚饭。说等他回来再解释。”"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "你听了准会高兴:这桩你一向忧心忡忡、视为不祥之举的事业,开端竟没有遭遇任何灾祸。我昨天到了这里;头一件事,便是要让我亲爱的姐姐放心:我一切安好,而且对此行的成功越来越有信心。",
      "我已远在伦敦以北。漫步在彼得堡的街头,我感到一阵清冽的北风拂面而来,叫我精神一振,满心欢喜。你能体会这种感觉吗?",
      "这些遐想驱散了我落笔之初的烦躁,我觉得心头燃起一股热望,把我高高托上云霄;因为再没有什么比一个坚定的目标——一个让灵魂得以凝神注视的定点——更能使人心境安宁的了。"
     ]
    },
    {
     "title": "第二封信",
     "type": "prose",
     "paragraphs": [
      "在这冰天雪地的包围之中,时光过得何其缓慢!然而,我向自己的事业又迈进了一步。",
      "可我有一桩心愿,至今未能如愿;而眼下它的缺憾,我感到是一种最难堪的苦楚:玛格丽特,我没有一个朋友。当我因成功而满腔热忱时,没有人来分享我的喜悦;当我遭受失望的打击时,也没有人来扶持我走出消沉。",
      "唉,这些抱怨都是徒劳的;在这茫茫大洋上,我固然找不到朋友,便是在阿尔汉格尔这里,在商人和水手之间,也一样找不到。然而,即便在这些粗犷的胸膛里,也跳动着某些不沾人性渣滓的情感。"
     ]
    },
    {
     "title": "第三封信",
     "type": "prose",
     "paragraphs": [
      "我匆匆写下几行,只为报个平安——航程也已大有进展。这封信将由一艘此刻正从阿尔汉格尔返航的商船带回英国;它比我幸运,而我或许要许多年后才能再见故土。",
      "迄今为止,我们还没遇上什么值得写进信里的事故。一两场猛烈的大风、船上漏了点水,这类小事,老练的航海家几乎懒得记上一笔;只要此行不出更糟的岔子,我就心满意足了。",
      "别了,我亲爱的玛格丽特。请放心:为了你,也为了我自己,我绝不会贸然涉险。我会冷静、坚韧、谨慎。"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "在十九世纪的最后那些年头里,谁也不会相信:这个世界正被某种比人类更高、却同人类一样难逃一死的智慧,敏锐而紧密地注视着;在人们忙于各自营生的时候,他们正被审视、被研究,其细致也许不亚于一个人用显微镜端详一滴水里那些蜂拥滋生、转瞬即逝的生物。",
      "火星这颗行星,我无需多提醒读者,绕日公转的平均距离约为一亿四千万英里,它从太阳获得的光和热,还不及我们这个世界的一半。",
      "然而人是这样自负,又被自负蒙蔽得这样厉害,以至直到十九世纪行将结束,竟没有一个作家表露过这样的念头:那上面或许已发展出智慧生命,其水平远在地球之上——甚至根本不曾想过那里会有生命。"
     ]
    },
    {
     "title": "第二章 · 陨星",
     "type": "prose",
     "paragraphs": [
      "随后便是第一颗陨星坠落的那一夜。它是清晨早早被人看见的,拖着一道火线掠过温彻斯特上空,高悬于大气之中。准有好几百人看见了它,只当是一颗寻常的流星。",
      "那个时辰我正在家中书房里写作;尽管我那扇落地长窗朝着奥特肖,百叶帘也卷着(那些日子我爱仰望夜空),我却什么也没看见。",
      "可是清晨极早的时候,可怜的奥吉尔维——他看见了那颗流星,认定有一块陨石落在了霍塞尔、奥特肖和沃金之间的荒野上某处——一早便起身去寻。黎明后不久,他果真找到了,就在沙坑近旁。"
     ]
    },
    {
     "title": "第三章 · 荒野上的圆筒",
     "type": "prose",
     "paragraphs": [
      "我看见大约二十来个人围在那个埋着圆筒的大坑四周。那庞然大物半陷在地里的模样,我前面已经描述过了。它周围的草皮和砂砾仿佛被一阵骤然的爆炸烧焦了。",
      "坑沿上坐着四五个男孩,垂着腿,拿石子去砸那庞然大物取乐——直到我把他们喝止。我同他们说过之后,他们便在围观人群里钻进钻出,玩起“捉人”来。",
      "这些人里有两个骑车的,一个我有时雇来打零工的园丁,一个抱着婴儿的姑娘,屠夫格雷格和他的小儿子,还有两三个惯在火车站一带游荡的闲汉和高尔夫球童。几乎没有人说话。"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "我父亲姓皮利普,我的教名叫菲利普,可我小时候舌头笨,两个名字都念不全、念不清,只能含含糊糊念成“匹普”。于是我就管自己叫匹普,后来大家也都叫我匹普。",
      "我说我父亲姓皮利普,依据是他墓碑上的字,还有我姐姐——乔·葛吉瑞太太,她嫁给了铁匠。",
      "我们家在沼泽地带,靠着河,顺河蜿蜒而下,离海约莫二十英里。我对万物的身世最初、也最鲜明开阔的印象,似乎是在一个难忘的、阴冷的傍晚得来的。"
     ]
    },
    {
     "title": "第二章",
     "type": "prose",
     "paragraphs": [
      "我姐姐乔·葛吉瑞太太比我大二十多岁,她因为是“一手”把我拉扯大的,便在自己和邻里心目中赢得了好大的名声。",
      "我姐姐长得并不好看;我大体上有个印象:多半是她硬逼着乔·葛吉瑞娶了她的。",
      "我姐姐乔太太一头黑发黑眼,皮肤却总是红通通的,弄得我有时纳闷:她洗脸莫非是用肉豆蔻擦子,而不是用肥皂?"
     ]
    },
    {
     "title": "第三章",
     "type": "prose",
     "paragraphs": [
      "那是个霜气弥漫、十分潮湿的清晨。我早看见湿气结在我那扇小窗的外面,仿佛有个妖精整夜在那儿哭泣,拿窗子当手帕使。",
      "等我走上沼泽地,雾更浓了;结果不是我朝什么东西扑去,倒像是什么东西都朝我扑来。这对一颗负罪的心来说,实在很不好受。",
      "这一路上,我朝着河边走去;可无论走得多快,两只脚总也暖不过来,那湿冷像是铆在了我脚上,就如铁铐铆在我要去会的那个人腿上一样。"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "歇洛克·福尔摩斯从壁炉台角上取下他那只瓶子,又从精致的摩洛哥皮盒里取出皮下注射器。他用那修长、苍白、神经质的手指调好纤细的针头,卷起左手的衬衫袖口。",
      "一连几个月,我每天三次目睹这套把戏,可习以为常并未使我的心安然接受。恰恰相反,这景象一天比一天叫我恼火;一想到自己竟没有勇气出言反对,我夜夜良心难安。",
      "然而那天下午,不知是午饭时喝的那点博恩葡萄酒作怪,还是他那从容不迫的做派格外叫人光火,我忽然觉得自己再也忍不下去了。"
     ]
    },
    {
     "title": "第二章 · 案情陈述",
     "type": "prose",
     "paragraphs": [
      "摩斯坦小姐步履稳健地走进屋来,外表镇定自若。她是位金发的年轻女子,身材娇小,手套整洁,衣着极有品味。不过,她的装束里有一种朴素与简单,隐隐透出手头并不宽裕。",
      "“福尔摩斯先生,我来找您,”她说,“是因为您曾帮我的雇主塞西尔·弗里斯特太太理清过一桩家庭小纠纷。她对您的好意和本领深为佩服。”",
      "“塞西尔·弗里斯特太太,”他若有所思地重复道,“我记得是为她效过一点微劳。不过那桩案子,据我记忆,是很简单的。”"
     ]
    },
    {
     "title": "第三章 · 寻求解答",
     "type": "prose",
     "paragraphs": [
      "直到五点半,福尔摩斯才回来。他神采奕奕、兴致勃勃,精神好极了——这种心境在他身上,总与那最阴郁的消沉轮番交替。",
      "“这桩事并没有什么大谜团,”他接过我替他斟的那杯茶,说道,“种种事实看来只容得下一种解释。”",
      "“唔,那样说就过头了。我不过发现了一个耐人寻味的事实罢了。然而它确实很耐人寻味。细节还有待补全。”"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "那陌生人是二月初一个冬日里来的,顶着刺骨的寒风和漫天飞雪——那是那年最后一场雪——翻过丘陵,从布兰勃赫斯特火车站一路走来,一只戴着厚手套的手提着一只黑色的小旅行箱。",
      "霍尔太太生起炉火,把他撇在屋里,自己亲手去给他张罗饭食。隆冬时节能有客人住到伊宾村来,真是闻所未闻的运气,何况这位客人还不是个“斤斤计较”的人,她便打定主意要显出自己配得上这份好运。",
      "她拿不准是否听清了他的话,正要把问题再问一遍。"
     ]
    },
    {
     "title": "第二章 · 第一印象",
     "type": "prose",
     "paragraphs": [
      "四点钟光景,天色已经相当暗了。霍尔太太正鼓起勇气,想进去问问她那位客人要不要用点茶,这时修钟表的泰迪·亨弗利走进了酒吧间。“我的天哪,霍尔太太,”他说,“这种天气穿薄靴子可真够受的!”",
      "霍尔太太点头称是,随即注意到他带着工具袋。“泰迪先生,既然你来了,”她说,“劳驾给客厅里那只旧钟瞧一瞧吧。它倒还走,报时也响亮有劲;可那时针就是不肯动,光指着六点。”",
      "说着,她领头走到客厅门口,敲了敲门,走了进去。"
     ]
    },
    {
     "title": "第三章 · 一千零一只瓶子",
     "type": "prose",
     "paragraphs": [
      "就这样,在二月二十九日、解冻刚开始的时候,这个古怪的人从无垠之中跌进了伊宾村。第二天,他的行李踏着泥泞运到了——那真是一批非同寻常的行李。",
      "他走下台阶,朝着大车尾部那只较小的板条箱走去,仿佛要伸手去搬它。",
      "可是,费伦赛德的狗一瞧见他,就立刻竖起毛、凶狠地咆哮起来;等他冲下台阶,那狗迟疑地一跳,随即直扑他的手。“嗬!”"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "一八六六年发生了一桩离奇的事件,一种神秘莫测、令人困惑的现象,想必至今无人忘记。",
      "此前一段时间,不少船只在海上遇见过“一个庞然大物”——一个长长的、纺锤形的东西,有时还会发出磷光,比鲸鱼大得多,行动也快得多。",
      "有关这一幽灵般之物的种种记载(载于各船的航海日志),在大多数方面都彼此吻合:那物体或生物的形状、它那不知疲倦的迅捷、它惊人的移动本领,以及它似乎所禀有的那种奇特的生命力。"
     ]
    },
    {
     "title": "第二章 · 赞成与反对",
     "type": "prose",
     "paragraphs": [
      "在J.B.霍布森的信送到之前三秒钟,我压根儿没想过去追捕那只“独角鲸”,正如没想过要去横渡北海一样。",
      "我刚结束一趟劳顿的旅行归来,疲惫不堪,一心只想歇息。我别无他求,只盼再见到我的祖国、我的朋友、我在植物园旁的小寓所,以及我那些珍贵的收藏。可是什么也拦不住我!",
      "“再说,”我心想,“条条大路终归通向欧洲(就当是专为我而设的吧),我又何必急着赶往法兰西海岸呢。”"
     ]
    },
    {
     "title": "第三章 · 悉听尊便",
     "type": "prose",
     "paragraphs": [
      "法拉古舰长是位出色的海员,无愧于他所统率的那艘三桅战舰。舰与人合而为一,他就是它的灵魂。在那海怪的问题上,他心里毫无疑虑,绝不容许船上有人质疑那动物的存在。",
      "舰上的军官们都赞同他们长官的看法。他们成天交谈、争论、推算着各种相遇的机会,密切注视着那辽阔的洋面。",
      "何况,法拉古舰长还许下过一笔两千美元的赏金,专留给头一个发现那海怪的人——不论他是船舱侍童、普通水手,还是军官。"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "一、从我祖父维鲁斯,我学到了温良与谦和,学会了戒除一切愤怒与激情;从生我父亲的声名与追念里,我学到了知耻,也学到了堂堂男子的风范。",
      "二、从把我抚养成人的那位,我学会了不痴迷于赛车场上“绿党”与“蓝党”那两大派系,也不在竞技场上偏袒任何一方的角斗士。"
     ]
    },
    {
     "title": "卷二 · 自省",
     "type": "prose",
     "paragraphs": [
      "一、要记住:你把这些事推延了多久;诸神一次次像是给你定下了某个日子、某个时辰,你却一再把它耽误过去。",
      "二、作为一个罗马人、一个大丈夫,你要时刻郑重不懈地用心:把你手头无论在做的什么事,都怀着真挚不假的庄重、自然的亲情、自由与公正去完成;至于其余一切牵挂与妄念,都要叫你的心从中解脱。",
      "三、做吧,我的灵魂,去做;你尽可糟践、轻贱自己;然而再过些时,你想要自重的时机,也就到头了。"
     ]
    },
    {
     "title": "卷三 · 无常",
     "type": "prose",
     "paragraphs": [
      "希波克拉底医好了许多疾病,自己却也染病而死。迦勒底的占星家们预言过不少人的死期,后来自己也照样被命运攫去。"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
   ...
   "chapters": [
    {
     ...
     "type": "prose",
     "paragraphs": [
      "一、求真的意志,那诱使我们去做种种冒险之事的意志,那一切哲学家迄今都满怀敬意谈论的著名的“真诚”——这求真的意志,究竟向我们提出过多少问题啊!何等离奇、何等令人困惑、何等可疑的问题!",
      "二、“一样东西怎么可能从它的对立面里产生呢?比如,真理从谬误里产生?求真的意志从骗人的意志里产生?慷慨之举从自私里产生?智者那纯净、阳光般明澈的洞见从贪欲里产生?”"
     ]
    },
    {
     "title": "第二章 · 自由的精神",
     "type": "prose",
     "paragraphs": [
      "二十四、哦,神圣的天真!人活在何等离奇的简化与曲解之中啊!一旦你睁开眼看清了这桩奇事,便会惊叹不已:我们竟把周遭的一切弄得这般明晰、自在、轻易而简单!",
      "二十五、在这样一番愉快的开场之后,该听一句正经话了,它是说给最严肃的心灵听的:留神,你们这些哲学家和爱智之士,谨防殉道!谨防“为真理而受难”!哪怕是为你们自己辩护而受难!",
      "二十六、每一个出类拔萃的人,都本能地为自己寻一座堡垒、一处隐居之地,好让自己摆脱群氓、摆脱多数,在那里忘掉“作为常规的人们”。"
     ]
    }
   ],
   "edition": "中译本 · 经典名著"
